...
## [2.11.9-alpha] - unreleased

This is an alpha version! The changes listed here are not final.

### Fixed
- Tests: Clear `COMPOSER_AUTH` environment variable when running Composer for tests.
...
[2.11.9-alpha]: https://github.com/Automattic/jetpack-autoloader/compare/v2.11.8...v2.11.9-alpha
