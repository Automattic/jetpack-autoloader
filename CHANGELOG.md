...
## [5.0.23-alpha] - unreleased

This is an alpha version! The changes listed here are not final.

### Removed
- Stop applying the root package's `exclude-from-classmap` autoload setting when generating the Jetpack class map.
...
[5.0.23-alpha]: https://github.com/Automattic/jetpack-autoloader/compare/v5.0.22...v5.0.23-alpha
