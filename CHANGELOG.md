...
### Added
- Add logic for debugging issues caused by conflicting Composer autoloaders, enabled by setting the `JETPACK_AUTOLOAD_DEBUG_CONFLICTING_LOADERS` constant.
- Add logic for debugging issues caused by early class loads, enabled by setting the `JETPACK_AUTOLOAD_DEBUG_EARLY_LOADS` constant.
...
[3.1.0-alpha]: https://github.com/Automattic/jetpack-autoloader/compare/v3.0.10...v3.1.0-alpha
