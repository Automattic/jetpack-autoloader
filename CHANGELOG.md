...
### Added
- Add an `AutoloadGenerator::VERSION` constant, and use that for the autoloader's version in preference to whatever Composer has.
...
[2.12.0-alpha]: https://github.com/Automattic/jetpack-autoloader/compare/v2.11.23...v2.12.0-alpha
